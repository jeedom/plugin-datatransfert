...
{nbsp} +
*Nom de l'utilisateur* : spécifier le nom de l'utilisateur SFTP utilisé pour la connexion. Utiliser un compte spécifique avec les droits nécessires (droits d'écriture dans le dossier cible du serveur sftp)
{nbsp} +
